...
// axios.defaults.baseURL = 'http://10.164.30.174/hinsei/server/public/api/'; //local
// axios.defaults.baseURL = 'http://10.164.30.174/HLAL_testing/server/public/api/'; //testing
axios.defaults.baseURL = 'http://10.164.30.174/HLAL/server/public/api/'; //prod
...
import {
    ...
    faUsers, faDesktop, faLock, faPlusSquare, faPencilAlt, faTrash, faFileLines, faHouse, faUserCircle, faUserPlus, faUserMinus, faSearch, faGear, faMagnifyingGlassPlus,
     ...
     faTable, faCaretLeft, faBookmark, faClock, faCircleArrowLeft, faTableList, faCircleArrowRight,faSquareCaretDown, faBan, faCheck, faFileExport
}
...
library.add(faUser, faInfoCircle, faBars, faAddressCard, faInfo, faAngleRight, faAngleDown, faClipboardList, faRing, faClone, faColumns,
    ...
    ,faSquareCaretDown,faCircleArrowRight, faCircleArrowLeft,faTableList, faBan, faCheck, faFileExport)
