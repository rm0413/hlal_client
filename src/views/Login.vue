    ...
    <svg class="absolute z-50 right-[37.8%] top-[42%]">
        <g id="Group_2" data-name="Group 2" class="animate-bounce">
            <g id="Group_1" data-name="Group 1" transform="translate(0 4.119)">
                <path id="Path_1" data-name="Path 1" d="M13.969-.111l56.525,7.52L-.239,31.9Z"
                    transform="translate(32.18 28.202) rotate(83)" fill="#fff175" />
                <g id="Path_5" data-name="Path 5" transform="translate(0 31.852) rotate(-45)" fill="none">
                    ...
                    <path
                        ...
                        stroke="none" fill="#fff175" />
                </g>
            </g>
            <g id="Path_6" data-name="Path 6" transform="translate(67.226 36.046) rotate(83)" fill="none">
...
const token = ref(window.location.href.split("/")[4] === "#" ? '' : window.location.href.split("/")[4])
const role = ref(window.location.href.split("/")[5] === "#" ? '' : window.location.href.split("/")[5])
