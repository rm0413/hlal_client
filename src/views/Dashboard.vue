  ...
  <div class="h-[89vh] w-full grid grid-cols-9 min-[100px]:overflow-y-scroll lg:overflow-y-hidden gap-2">
    <div class="lg:col-span-6 min-[100px]:col-span-9 h-full flex flex-col">
      ...
      <div class="grid grid-rows-2 h-[70%]">
        ...
        <div class="row-span-1 grid grid-cols-2 mt-7">
      ...
      <div class="grid grid-cols-2 h-[10%] mt-9">
        <div class="col-span-1 flex justify-center items-center gap-2">
          ...
          <button
            class="w-[10rem] h-[2rem] bg-blue-500 text-white rounded-full flex justify-center text-[14px] items-center font-bold">{{ hinsei_count }}</button>
        </div>
        <div class="col-span-1 flex justify-center items-center gap-2">
          Total number of LSA Request<button
            class="w-[10rem] h-[2rem] bg-orange-600 text-white rounded-full flex justify-center text-[14px] items-center font-bold">{{ lsa_count }}</button>
        </div>
      </div>
    </div>
