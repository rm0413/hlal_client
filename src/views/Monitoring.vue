<template>
  ...
  >
    <div class="lg:col-span-3 min-[100px]:col-span-9 h-[89vh] flex flex-col">
      ...
      <div class="flex flex-col">
        ...
        <form action="" class="flex flex-col items-center gap-2">
          <label for="" class="flex flex-col mt-3">
            ...
            <input
              type="text"
              class="border p-2 flex text-center w-[31.5vw]"
          ...
          <div class="flex gap-5 mt-5">
            <button type="button" class="p-2 bg-green-700 text-white rounded">
    ...
    <div class="lg:col-span-6 min-[100px]:col-span-9 h-[70vh]">
