    ...
    <div class="h-full w-full">
      <div class="flex justify-between">
        ...
        <div class="flex gap-2">
          ...
          <div class="relative">
            <i
              class="h-full z-50 text-gray-400 top-[2px] py-1 px-3 rounded absolute"
            ...
            />
            <button
              class="bg-gray-400 text-white py-1 px-3 rounded-r-md h-[2.5rem]"
            >
              Search
            </button>
          </div>
          <div>
            <c-select
              class="text-center w-[15rem] border-gray-600 hover:border-blue-300 outline-green-600"
              :options="part_number"
    ...
    >
      ...
      >
        <form method="post" @submit.prevent="submitDesignerSectionAnswer">
          ...
          <label class="flex flex-col items-center">
            <i
              class="text-white bg-[#A10E13] w-full flex justify-center rounded mb-2"
