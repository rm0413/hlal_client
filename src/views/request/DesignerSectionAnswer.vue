      ...
      swal({
        ...
        if (response.value === true) {
          ...
          data_storage.forEach((item, i) => {
            formData.append(
              `${name}[${i}]${["[agreement_request_id]"]}`,
              item["agreement_request_id_fk"]
            );
            formData.append(
              `${name}[${i}]${["[trial_number]"]}`,
              item["trial_number"]
            ...
            formData.append(
              `${name}[${i}]${["[additional_request_qty_date]"]}`,
              item["additional_request_qty_date"]
            );
            formData.append(
              `${name}[${i}]${["[tri_number]"]}`,
              item["tri_number"]
            ...
            formData.append(
              `${name}[${i}]${["[request_person]"]}`,
              item["request_person"]
            );
            formData.append(
              `${name}[${i}]${["[superior_approval]"]}`,
              item["superior_approval"]
            );
            formData.append(
            ...
            formData.append(
              `${name}[${i}]${["[sub_part_number]"]}`,
              item["sub_part_number"]
            );
            ...
            formData.append(
              `${name}[${i}]${["[critical_parts]"]}`,
              item["critical_parts"]
            );
            formData.append(
              `${name}[${i}]${["[critical_dimension]"]}`,
              item["critical_dimension"]
            );
            formData.append(
              `${name}[${i}]${["[request_type]"]}`,
              item["request_type"]
            ...
            formData.append(
              `${name}[${i}]${["[request_value]"]}`,
              item["request_value"]
            );
            formData.append(
              `${name}[${i}]${["[request_quantity]"]}`,
              item["request_quantity"]
            );
            formData.append(`${name}[${i}]${["[unit_id]"]}`, item["unit_id"]);
            formData.append(
              `${name}[${i}]${["[requestor_employee_id]"]}`,
              item["requestor_employee_id"]
            );
          });
