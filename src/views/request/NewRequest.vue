      ...
      <div class="flex justify-between">
        ...
        <div class="flex gap-2 mr-10">
          <div class="flex flex-row">
            ...
            <button @click="openModal('new_unit')" class="h-full bg-[#A10E13] text-white py-1 px-3 rounded-r-md">
      ...
      <form class="grid grid-cols-3" action="">
        ...
        <div class="col-span-1 p-10">
          ...
          <label class="flex flex-col gap-2">
            ...
            <textarea
              style="resize: none"
              class="w-full border-2 rounded p-1 hover:border-blue-300 h-[6.5rem]"
            />
          </label>
          <label class="flex flex-col gap-2">
            Request Quantity
