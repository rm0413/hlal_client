<template>
  ...
  >
      ...
      <div class="flex justify-between">
        ...
        <div class="flex gap-2 mr-10">
          ...
          <div class="relative">
            ...
            ></i>
            <input
              class="text-center p-1 border-2 rounded-l-md h-[2.5rem]"
      ...
      <form class="grid grid-cols-3" action="post" @submit.prevent="submitAgreementList">
        <div class="col-span-1 p-10">
          <label class="flex flex-col gap-2">
            ...
            <input
              type="text"
              class="w-full border-2 rounded p-1 hover:border-blue-300 text-center"
          ...
          <label class="flex flex-col gap-2">
            ...
            <input
              type="date"
              class="w-full text-center border-2 rounded p-1 hover:border-blue-300"
        ...
        <div class="col-span-1 p-10">
          <label class="flex flex-col gap-2">
            ...
            <c-select
              ...
              :options="critical_parts_options"
              class="text-center"
            ></c-select>
          </label>
          <label class="flex flex-col gap-2">
            ...
            <c-select
              ...
              :options="critical_dimension_options"
              class="text-center"
            ></c-select>
          </label>
          <label class="flex flex-col gap-2">
          ...
          <div class="flex justify-center items-center mt-8 gap-2">
            ...
            <button
              type="button"
              class="bg-gray-700 text-white p-1 w-[7rem] rounded"
    ...
    <dialog
      ref="view_items"
      class="p-0 rounded transform duration-300 -translate-y-5 w-full"
    >
      <div class="flex flex-col">
        <div
          class="flex justify-between items-center h-[5vh] px-3 text-white bg-[#A10E13]"
        ...
        <div class="flex p-5 max-h-[50vh] overflow-y-scroll">
          <CTable
            ref="ctable"
            :isSelectable="true"
            @selectable="(data) => (checkedData = data)"
        ...
        <button
          class="p-3 bg-[#A10E13] text-white hover:bg-red-600"
          @click="generateCode"
        >
          Generate
        </button>
        ...
        <div class="flex p-5 overflow-y-scroll">
          ...
          >
            ...
            <template #cell(action)="data">
              <button
                type="button"
                class="bg-[#A10E13] text-white hover:bg-red-600 rounded w-[4rem] h-[2rem]"
...
const submitAgreementList = () => {
  if (
    newRequestStore.agreementForm.unit &&
    newRequestStore.agreementForm.critical_parts &&
    newRequestStore.agreementForm.critical_dimension &&
    newRequestStore.agreementForm.kind_request
  ) {
    swal({
      icon: "question",
    ...
    toast.add({
      ...
      detail:
        "Please Select Critical Parts/Critical Dimension/Kind of Request/ Unit Options",
      life: 3000,
    });
  }
};
